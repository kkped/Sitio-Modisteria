...
<head>
    ...
    <!-- Favicon -->
    <link href="<?php echo base_url('assets/sitio/img/favicon.ico')?> rel="icon">
    ...
    <link href="<?php echo base_url('assets/sitio/.min.css')?> rel="stylesheet">
    <link href="<?php echo base_url('assets/sitio/.css')?> rel="stylesheet">
    ...
    <link href="<?php echo base_url('assets/sitio/css/bootstrap.min.css')?> rel="stylesheet">

    <!-- Template Stylesheet -->
    <link href="<?php echo base_url('assets/sitio/css/style.css')?> rel="stylesheet">
</head>
...
<body>
    ...
    <script src="<?php echo base_url('assets/sitio/.jquery.com/jquery-3.4.1.min.js')?>"></script>
    <script src="<?php echo base_url('assets/sitio/bootstrap@5.0.0/dist/js/bootstrap.bundle.min.js')?>"></script>
    <script src="<?php echo base_url('assets/sitio/.min.js')?>"></script>
    <script src="<?php echo base_url('assets/sitio/.min.js')?>"></script>
    <script src="<?php echo base_url('assets/sitio/.min.js')?>"></script>
    <script src="<?php echo base_url('assets/sitio/.min.js')?>"></script>

    <!-- Template Javascript -->
    <script src="<?php echo base_url('assets/sitio/js/main.js')?>"></script>
</body>
