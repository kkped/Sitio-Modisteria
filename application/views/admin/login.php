...
<!--===============================================================================================-->	
	<link rel="icon" type="images/png" href="http://localhost/modisteriamosquera/assets/form/images/icons/favicon.png"/>
<!--===============================================================================================-->
...
<body>
	...
	<div class="limiter">
		...
		<div class="container-login100" style="background-image: url('images/.jpg');">
			...
			<?php if(isset($error)):?>
		<p class="alert alert-primary">Usuario Y contraseña No coinciden</p>
		<?php endif; ?>

				<?php if(isset($_SESSION['error_session'])): ?>
                   <div class="row">
                    <p class="alert alert-success">No coinciden los datos</p>
                   </div>
                   <?php endif; ?>
				...
				<form  action="http://localhost/modisteriamosquera/index.php/session/session"method="post" class="login100-form validate-form p-b-33 p-t-5">
